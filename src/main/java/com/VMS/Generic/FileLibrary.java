...
public class FileLibrary {
	...
	/**
	 * This is the generic method for Reading/Taking data from Excel file
	 * @param path
	 * @param sheet
	 * @param row
	 * @param cell
	 ...
	 * @throws IOException
	 */
	public String readExcel(String path,String sheet,int row,int cell) throws EncryptedDocumentException, IOException
	{
	 ...
	 * @throws IOException
	 */
	public double readnumExcel(String path,String sheet,int row,int cell) throws EncryptedDocumentException, IOException
	{
		FileInputStream fis=new FileInputStream(path);
		Workbook wb=WorkbookFactory.create(fis);
